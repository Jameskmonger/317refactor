    ...
    private void method22()
    {
        try
        {
            ...
            if(k3 < plane - 1)
                k3 = plane - 1;
            if(lowMemory)
                worldController.setHeightLevel(ObjectManager.anInt145);
            else
...
//	notifyItemSpawn(item, i + baseX, j + baseY);
        ...
        worldController.addGroundItemTile(i, j, plane, method42(plane, j * 128 + 64, i * 128 + 64), i1, ((Animable) (obj)), ((Animable) (obj1)), ((Animable) (obj2)));
    }
    ...
    private void updateEntities()
    {
            ...
            for(int j = -1; j < playerCount + npcCount; j++)
        {
            ...
            if(j < playerCount)
            {
                ...
                if(j >= 0 && anInt855 == 10 && anInt933 == playerId[j])
                {
                    npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 15);
                    if(spriteDrawX > -1)
 ...
 //       myPassword = "";
    ...
    private void updatePlayersBlock(Stream stream)
    {
        for(int p = 0; p < actorsAwaitingUpdatePointer; p++)
        {
            ...
            int updateFlag = stream.getUnsignedByte();
            if((updateFlag & 0x40) != 0)
                updateFlag += stream.getUnsignedByte() << 8;
            updatePlayer(stream, updateFlag, player, pId);
        }
    ...
    private void loadingStages()
    {
        ...
        {
            aRSImageProducer_1165.initDrawingArea();
            aTextDrawingArea_1271.drawTextHMidVTop("Loading - please wait.", 257, 151, 0);
            aTextDrawingArea_1271.drawTextHMidVTop("Loading - please wait.", 256, 150, 0xffffff);
    ...
    {
        GameObjectSpawnRequest class30_sub1 = (GameObjectSpawnRequest)aClass19_1179.reverseGetFirst();
  ...
  */
    ...
    private void dropClient()
    {
        ...
        aRSImageProducer_1165.initDrawingArea();
        aTextDrawingArea_1271.drawTextHMidVTop("Connection lost", 257, 144, 0);
        aTextDrawingArea_1271.drawTextHMidVTop("Connection lost", 256, 143, 0xffffff);
        aTextDrawingArea_1271.drawTextHMidVTop("Please wait - attempting to reestablish", 257, 159, 0);
        aTextDrawingArea_1271.drawTextHMidVTop("Please wait - attempting to reestablish", 256, 158, 0xffffff);
        aRSImageProducer_1165.drawGraphics(4, super.gameGraphics, 4);
        minimapState = 0;
        destX = 0;
    ...
    private void doAction(int i)
    {
        ...
        if(l == 639)
        {
            ...
            if(k2 != -1)
            {
                ...
                if(target != -1 && friendsNodeIDs[target] > 0)
                {
                    inputTaken = true;
                    inputDialogState = 0;
                    messagePromptRaised = true;
    ...
    private void login(String playerUsername, String playerPassword, boolean recoveredConnection)
    {
        ...
        try
        {
            ...
            if(responseCode == 0)
            {
                ...
                serverSessionKey = inStream.readLong();
                int seed[] = new int[4];
    ...
    private void updateNPCBlock(Stream stream)
    {
        for(int n = 0; n < actorsAwaitingUpdatePointer; n++)
        {
            ...
            NPC npc = npcArray[npcId];
            int flag = stream.getUnsignedByte();
            if((flag & 0x10) != 0)
            {
 ...
 //           return;
    ...
    private void drawGameScreen()
    {
        ...
        if(updateChatSettings)
        {
            ...
            aTextDrawingArea_1271.drawShadowTextHMidVTop(0xffffff, 55, "Public chat", 28, true);
            if(publicChatMode == 0)
                aTextDrawingArea_1271.drawShadowTextHMidVTop(65280, 55, "On", 41, true);
            if(publicChatMode == 1)
                aTextDrawingArea_1271.drawShadowTextHMidVTop(0xffff00, 55, "Friends", 41, true);
            if(publicChatMode == 2)
                aTextDrawingArea_1271.drawShadowTextHMidVTop(0xff0000, 55, "Off", 41, true);
            if(publicChatMode == 3)
                aTextDrawingArea_1271.drawShadowTextHMidVTop(65535, 55, "Hide", 41, true);
            aTextDrawingArea_1271.drawShadowTextHMidVTop(0xffffff, 184, "Private chat", 28, true);
            if(privateChatMode == 0)
                aTextDrawingArea_1271.drawShadowTextHMidVTop(65280, 184, "On", 41, true);
            if(privateChatMode == 1)
                aTextDrawingArea_1271.drawShadowTextHMidVTop(0xffff00, 184, "Friends", 41, true);
            if(privateChatMode == 2)
                aTextDrawingArea_1271.drawShadowTextHMidVTop(0xff0000, 184, "Off", 41, true);
            aTextDrawingArea_1271.drawShadowTextHMidVTop(0xffffff, 324, "Trade/compete", 28, true);
            if(tradeMode == 0)
                aTextDrawingArea_1271.drawShadowTextHMidVTop(65280, 324, "On", 41, true);
            if(tradeMode == 1)
                aTextDrawingArea_1271.drawShadowTextHMidVTop(0xffff00, 324, "Friends", 41, true);
            if(tradeMode == 2)
                aTextDrawingArea_1271.drawShadowTextHMidVTop(0xff0000, 324, "Off", 41, true);
            aTextDrawingArea_1271.drawShadowTextHMidVTop(0xffffff, 458, "Report abuse", 33, true);
    ...
    private void updatePlayer(Stream stream, int flag, Player player, int playerId)
    {
        if((flag & 0x400) != 0)
        {
    ...
    private void method108()
    {
        ...
        {
            signlink.reporterror("glfc_ex " + localPlayer.x + "," + localPlayer.y + "," + anInt1014 + "," + anInt1015 + "," + anInt1069 + "," + anInt1070 + "," + baseX + "," + baseY);
            throw new RuntimeException("eek");
        }
    }
    ...
    private void draw3dScreen()
    {
        ...
        if(fpsOn)
        {
            ...
            if(super.fps < 15)
                i1 = 0xff0000;
            aTextDrawingArea_1271.drawTextHRightVTop("Fps:" + super.fps, c, k, i1);
            k += 15;
            ...
            if(j1 > 0x2000000 && lowMemory)
                i1 = 0xff0000;
            aTextDrawingArea_1271.drawTextHRightVTop("Mem:" + j1 + "k", c, k, 0xffff00);
            k += 15;
        }
        if(anInt1104 != 0)
        {
            ...
            j %= 60;
            if(j < 10)
                aTextDrawingArea_1271.drawTextHLeftVTop("System update in: " + l + ":0" + j, 4, 329, 0xffff00);
            else
                aTextDrawingArea_1271.drawTextHLeftVTop("System update in: " + l + ":" + j, 4, 329, 0xffff00);
            anInt849++;
            if(anInt849 > 75)
            {
                anInt849 = 0;
    ...
    private void updateSpawnedObjects()
    {
        if(loadingStage == 2)
        {
            for(GameObjectSpawnRequest spawnRequest = (GameObjectSpawnRequest)aClass19_1179.reverseGetFirst(); spawnRequest != null; spawnRequest = (GameObjectSpawnRequest)aClass19_1179.reverseGetNext())
            {
                if(spawnRequest.anInt1294 > 0)
                    spawnRequest.anInt1294--;
                if(spawnRequest.anInt1294 == 0)
                {
                    if(spawnRequest.anInt1299 < 0 || ObjectManager.method178(spawnRequest.anInt1299, spawnRequest.anInt1301))
                    {
                        method142(spawnRequest.anInt1298, spawnRequest.anInt1295, spawnRequest.anInt1300, spawnRequest.anInt1301, spawnRequest.anInt1297, spawnRequest.anInt1296, spawnRequest.anInt1299);
                        spawnRequest.unlink();
                    }
                } else
                {
                    if(spawnRequest.anInt1302 > 0)
                        spawnRequest.anInt1302--;
                    if(spawnRequest.anInt1302 == 0 && spawnRequest.anInt1297 >= 1 && spawnRequest.anInt1298 >= 1 && spawnRequest.anInt1297 <= 102 && spawnRequest.anInt1298 <= 102 && (spawnRequest.anInt1291 < 0 || ObjectManager.method178(spawnRequest.anInt1291, spawnRequest.anInt1293)))
                    {
                        method142(spawnRequest.anInt1298, spawnRequest.anInt1295, spawnRequest.anInt1292, spawnRequest.anInt1293, spawnRequest.anInt1297, spawnRequest.anInt1296, spawnRequest.anInt1291);
                        spawnRequest.anInt1302 = -1;
                        if(spawnRequest.anInt1291 == spawnRequest.anInt1299 && spawnRequest.anInt1299 == -1)
                            spawnRequest.unlink();
                        else
                        if(spawnRequest.anInt1291 == spawnRequest.anInt1299 && spawnRequest.anInt1292 == spawnRequest.anInt1300 && spawnRequest.anInt1293 == spawnRequest.anInt1301)
                            spawnRequest.unlink();
                    }
                }
            }
            ...
            if(class9_1.type == 6 && (class9_1.anInt257 != -1 || class9_1.anInt258 != -1))
            {
                ...
                if(l != -1)
                {
                    ...
                    for(class9_1.animationDuration += i; class9_1.animationDuration > animation.getFrameLength(class9_1.animationFrame);)
                    {
                        ...
                        {
                            class9_1.animationFrame -= animation.anInt356;
...
//aryan	entity.entScreenX = spriteDrawX; entity.entScreenY = spriteDrawY;
        ...
        for(int j = 0; j < 100; j++)
            if(chatMessages[j] != null)
            {
                ...
                if((k == 3 || k == 7) && (k == 7 || privateChatMode == 0 || privateChatMode == 1 && isFriendOrSelf(s)))
                {
                    ...
                    {
                        int i1 = aTextDrawingArea_1271.getFormattedStringWidth("From:  " + s + chatMessages[j]) + 25;
                        if(i1 > 450)
                            i1 = 450;
                           ...
                           int l1, int i2, int j2)
    {
        ...
        for(GameObjectSpawnRequest class30_sub1_1 = (GameObjectSpawnRequest)aClass19_1179.reverseGetFirst(); class30_sub1_1 != null; class30_sub1_1 = (GameObjectSpawnRequest)aClass19_1179.reverseGetNext())
        {
 ...
 //               return new DataInputStream((new URL(getCodeBase(), s)).openStream());
    ...
    private void method137(Stream stream, int j)
    {
        ...
        if(j == 105)
        {
            ...
            int i14 = l11 >> 4 & 0xf;
            int i16 = l11 & 7;
            if(localPlayer.smallX[0] >= k3 - i14 && localPlayer.smallX[0] <= k3 + i14 && localPlayer.smallY[0] >= j6 - i14 && localPlayer.smallY[0] <= j6 + i14 && aBoolean848 && !lowMemory && anInt1062 < 50)
            {
        ...
        if(j == 215)
        {
            ...
            if(k6 >= 0 && j9 >= 0 && k6 < 104 && j9 < 104 && i12 != playerListId)
            {
        ...
        if(j == 151)
        {
            ...
            int j10 = stream.getUnsignedShort();
...
*/
    ...
    private boolean parsePacket()
    {
        ...
        try
        {
            ...
            if(packetOpcode == 176)
            {
                daysSinceRecovChange = inStream.getUnsignedByteC();
            ...
            if(packetOpcode == 64)
            {
                anInt1268 = inStream.getUnsignedByteC();
                anInt1269 = inStream.getUnsignedByteS();
                ...
                for(GameObjectSpawnRequest class30_sub1 = (GameObjectSpawnRequest)aClass19_1179.reverseGetFirst(); class30_sub1 != null; class30_sub1 = (GameObjectSpawnRequest)aClass19_1179.reverseGetNext())
            ...
            if(packetOpcode == 185)
            {
                int k = inStream.getUnsignedShortA();
                RSInterface.interfaceCache[k].anInt233 = 3;
                if(localPlayer.npcAppearance == null)
                    RSInterface.interfaceCache[k].mediaID = (localPlayer.bodyPartColour[0] << 25) + (localPlayer.bodyPartColour[4] << 20) + (localPlayer.appearance[0] << 15) + (localPlayer.appearance[8] << 10) + (localPlayer.appearance[11] << 5) + localPlayer.appearance[1];
                else
                    RSInterface.interfaceCache[k].mediaID = (int)(0x12345678L + localPlayer.npcAppearance.type);
                packetOpcode = -1;
                return true;
            }
            if(packetOpcode == 107)
            ...
            if(packetOpcode == 72)
            {
                int i1 = inStream.getUnsignedShort();
            ...
            if(packetOpcode == 71)
            {
                ...
                int j10 = inStream.getUnsignedByteA();
                if(l1 == 65535)
                    l1 = -1;
            ...
            if(packetOpcode == 74)
            {
                int i2 = inStream.getUnsignedShort();
                if(i2 == 65535)
                    i2 = -1;
            ...
            if(packetOpcode == 121)
            {
                int j2 = inStream.getUnsignedShortA();
                int k10 = inStream.getUnsignedLEShortA();
            ...
            if(packetOpcode == 70)
            {
                ...
                int i16 = inStream.getUnsignedShort();
	...
	int l2 = anInt1069;
                ...
                if(packetOpcode == 73)
                {
                    l2 = inStream.getUnsignedLEShortA();
                    i11 = inStream.getUnsignedLEShort();
                    aBoolean1159 = false;
                }
                if(packetOpcode == 241)
                {
                    i11 = inStream.getUnsignedLEShortA();
            ...
            if(packetOpcode == 75)
            {
                int j3 = inStream.getUnsignedShortA();
                int j11 = inStream.getUnsignedShortA();
            ...
            if(packetOpcode == 114)
            {
                anInt1104 = inStream.getUnsignedShort() * 30;
                packetOpcode = -1;
                return true;
            }
            if(packetOpcode == 60)
            ...
            if(packetOpcode == 104)
            {
                int j4 = inStream.getUnsignedByteC();
                int i12 = inStream.getUnsignedByteA();
                String s6 = inStream.getString();
                if(j4 >= 1 && j4 <= 5)
                {
	...
	//serverMessage(s);
            ...
            if(packetOpcode == 248)
            {
                int i5 = inStream.getUnsignedLEShortA();
            ...
            if(packetOpcode == 79)
            {
                int j5 = inStream.getUnsignedShort();
                int l12 = inStream.getUnsignedLEShortA();
            ...
            if(packetOpcode == 85)
            {
                anInt1269 = inStream.getUnsignedByteC();
                anInt1268 = inStream.getUnsignedByteC();
                packetOpcode = -1;
                return true;
            }
            if(packetOpcode == 24)
            {
                anInt1054 = inStream.getUnsignedByteS();
                if(anInt1054 == tabID)
                {
                    if(anInt1054 == 3)
                        tabID = 1;
            ...
            if(packetOpcode == 246)
            {
                int i6 = inStream.getUnsignedShort();
            ...
            if(packetOpcode == 142)
            {
                int j6 = inStream.getUnsignedShort();
                loadInterface(j6);
                if(backDialogID != -1)
                {
                    backDialogID = -1;
            ...
            if(packetOpcode == 126)
            {
                ...
                int k13 = inStream.getUnsignedLEShortA();
            ...
            if(packetOpcode == 8)
            {
                int k6 = inStream.getUnsignedShortA();
            ...
            if(packetOpcode == 122)
            {
                int l6 = inStream.getUnsignedShortA();
                int i14 = inStream.getUnsignedShortA();
                int i19 = i14 >> 10 & 0x1f;
                int i22 = i14 >> 5 & 0x1f;
                int l24 = i14 & 0x1f;
            ...
            if(packetOpcode == 53)
            {
                ...
                for(int j22 = 0; j22 < j19; j22++)
                {
                    ...
                    class9_1.inv[j22] = inStream.getUnsignedShortA();
            ...
            if(packetOpcode == 87)
            {
                int j8 = inStream.getUnsignedShort();
            ...
            if(packetOpcode == 36)
            {
                int k8 = inStream.getUnsignedShort();
            ...
            if(packetOpcode == 164)
            {
                int j9 = inStream.getUnsignedShort();
                loadInterface(j9);
                if(invOverlayInterfaceID != -1)
                {
                    invOverlayInterfaceID = -1;
    ...
    private void method146()
    {
        ...
        if(!aBoolean1160)
        {
            ...
            setCameraPos(600 + i * 3, i, anInt1014, method42(plane, localPlayer.y, localPlayer.x) - 50, k, anInt1015);
        }
        int j;
        if(!aBoolean1160)
            j = method120();
