final class CollisionMap
{
    ...
    public boolean reachedWallDecoration(int startX, int startY, int endX, int endY, int endPosition, int endOrientation)
    {
        if(startX == endX && startY == endY)
            return true;
        startX -= insetX;
                             ...
                             int surroundings)
    {
        ...
        if(startX >= endX && startX <= endX2 && startY >= endY && startY <= endY2)
            return true;
        if(startX == endX - 1 && startY >= endY && startY <= endY2 && (clippingData[startX - insetX][startY - insetY] & 8) == 0 && (surroundings & 8) == 0)
            return true;
        if(startX == endX2 + 1 && startY >= endY && startY <= endY2 && (clippingData[startX - insetX][startY - insetY] & 0x80) == 0 && (surroundings & 2) == 0)
            return true;
        return startY == endY - 1 && startX >= endX && startX <= endX2 && (clippingData[startX - insetX][startY - insetY] & 2) == 0 && (surroundings & 4) == 0 || startY == endY2 + 1 && startX >= endX && startX <= endX2 && (clippingData[startX - insetX][startY - insetY] & 0x20) == 0 && (surroundings & 1) == 0;
    }
