...
public final class ItemDefinition
{
    ...
    public Model getDialogueModel(int gender)
    {
        ...
        if(dialogueHatModelId != -1)
        {
            ...
            Model dialogueModels[] = {
                    dialogueModel, dialogueHatModel
            };
    ...
    public Model getEquippedModel(int gender)
    {
        ...
        if(equipModelIdSecondary != -1)
            if(equipModelIdEmblem != -1)
            {
                ...
                Model models[] = {
                        modelPrimary, modelSecondary, modelEmblem
                };
    ...
    public static Sprite getSprite(int itemId, int itemAmount, int type)
    {
        ...
        model.renderSingle(definition.modelRotationY, definition.modelRotationZ, definition.modelRotationX, definition.modelOffset1, l3 + model.modelHeight / 2 + definition.modelOffset2, i4 + definition.modelOffset2);
        for(int _x = 31; _x >= 0; _x--)
        {
            for(int _y = 31; _y >= 0; _y--)
                if(itemSprite.pixels[_x + _y * 32] == 0)
                    ...
                    if(_y > 0 && itemSprite.pixels[_x + (_y - 1) * 32] > 1)
                        itemSprite.pixels[_x + _y * 32] = 1;
                    else
                    if(_x < 31 && itemSprite.pixels[_x + 1 + _y * 32] > 1)
                        itemSprite.pixels[_x + _y * 32] = 1;
                    else
                    if(_y < 31 && itemSprite.pixels[_x + (_y + 1) * 32] > 1)
                        itemSprite.pixels[_x + _y * 32] = 1;
        ...
        if(type == 0)
        {
            ...
            {
                for(int _y = 31; _y >= 0; _y--)
                    if(itemSprite.pixels[_x + _y * 32] == 0 && _x > 0 && _y > 0 && itemSprite.pixels[(_x - 1) + (_y - 1) * 32] > 0)
    ...
    private void readValues(Stream stream)
    {
        do
        {
            ...
            if(attribute >= 100 && attribute < 110)
            {
